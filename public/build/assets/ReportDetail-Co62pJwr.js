...
Trying alternative method...`),j()}finally{p.value=!1}},j=()=>{try{const o=$(),e=new Blob([o],{type:"application/msword;charset=utf-8"}),r=document.createElement("a"),n=window.URL.createObjectURL(e);r.href=n,r.download=`${i.report.title.replace(/\s+/g,"-")}-${Date.now()}.doc`,document.body.appendChild(r),r.click(),document.body.removeChild(r),window.URL.revokeObjectURL(n)}catch(o){console.error("Fallback export error:",o),alert("Failed to export document. Please use the Print PDF option instead.")}},$=()=>{const o=i.report.data;let e=`
    ...
    <table>
        ...
        <tbody>
            ${o.top_searches?.map((n,u)=>{const v=o.total_searches>0?Math.round(n.count/o.total_searches*100):0;return`
                <tr>
                    <td>${u+1}</td>
                    <td>${n.query}</td>
    ...
    <table>
        ...
        <tbody>
            ${o.guest_roles.map(n=>{const u=o.total_searches>0?Math.round(n.count/o.total_searches*100):0;return`
                <tr>
                    <td style="text-transform: capitalize;">${n.role}</td>
                    <td>${n.count.toLocaleString()}</td>
                    <td>${u}%</td>
                </tr>`}).join("")}
        </tbody>
...
`,M=o=>({usage:"bg-green-50 text-green-900",feedback:"bg-green-50 text-green-900",facility:"bg-green-50 text-green-900",search:"bg-green-50 text-green-900"})[o]||"bg-green-50 text-green-900",x=(o,e)=>e>0?Math.round(o/e*100):0;return(o,e)=>(a(),B(U,null,{default:P(()=>[t("div",Z,[t("div",G,[t("button",{onClick:e[0]||(e[0]=r=>h(V).back()),class:"flex items-center gap-2 text-sm text-gray-600 hover:text-green-900 mb-4 transition"},[g(h(E),{class:"h-4 w-4"}),e[1]||(e[1]=k(" Back to Reports ",-1))]),t("div",W,[t("div",X,[t("div",I,[t("h1",Y,d(s.report.title),1),t("span",{class:z(["px-3 py-1 rounded-full text-xs font-semibold uppercase",M(s.report.type)])},d(s.report.type),3)]),t("p",J,d(s.report.description),1),t("div",K,[t("div",tt,[g(h(N),{class:"h-4 w-4"}),t("span",null,"Generated "+d(_(s.report.created_at)),1)]),s.report.period_from?(a(),l("div",et,[g(h(Q),{class:"h-4 w-4"}),t("span",null,d(_(s.report.period_from))+" - "+d(_(s.report.period_to)),1)])):c("",!0)])]),t("div",ot,[t("button",{onClick:L,disabled:p.value,class:"flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-green-900 bg-white border border-green-300 hover:bg-green-50 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"},[g(h(H),{class:"h-4 w-4"}),e[2]||(e[2]=k(" Print PDF ",-1))],8,rt),t("button",{onClick:C,disabled:p.value,class:"flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-green-900 hover:bg-green-800 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"},[g(h(O),{class:"h-4 w-4"}),k(" "+d(p.value?"Exporting...":"Export DOCX"),1)],8,st)])])]),s.report.type==="usage"?(a(),l("div",dt,[t("div",nt,[t("div",at,[t("div",lt,[e[3]||(e[3]=t("p",{class:"text-sm font-medium text-green-700"},"Total Searches",-1)),g(h(y),{class:"h-5 w-5 text-green-900"})]),t("p",it,d(s.report.data.total_searches?.toLocaleString()||0),1)]),t("div",ct,[t("div",ht,[e[4]||(e[4]=t("p",{class:"text-sm font-medium text-green-700"},"Unique Searchers",-1)),g(h(y),{class:"h-5 w-5 text-green-900"})]),t("p",gt,d(s.report.data.unique_searchers?.toLocaleString()||0),1)]),t("div",ut,[t("div",bt,[e[5]||(e[5]=t("p",{class:"text-sm font-medium text-green-700"},"Avg. Searches/User",-1)),g(h(y),{class:"h-5 w-5 text-green-900"})]),t("p",mt,d(s.report.data.unique_searchers>0?(s.report.data.total_searches/s.report.data.unique_searchers).toFixed(1):0),1)]),t("div",pt,[t("div",xt,[e[6]||(e[6]=t("p",{class:"text-sm font-medium text-green-700"},"Top Query Count",-1)),g(h(y),{class:"h-5 w-5 text-green-900"})]),t("p",ft,d(s.report.data.top_searches?.[0]?.count?.toLocaleString()||0),1)])]),t("div",yt,[e[9]||(e[9]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"Top Search Queries"),t("p",{class:"text-sm text-green-700 mt-1"},"Most frequently searched terms")],-1)),t("div",wt,[t("table",_t,[e[8]||(e[8]=t("thead",{class:"bg-green-50"},[t("tr",null,[t("th",{class:"px-6 py-3 text-left text-xs font-semibold text-green-900 uppercase tracking-wider"},"Rank"),t("th",{class:"px-6 py-3 text-left text-xs font-semibold text-green-900 uppercase tracking-wider"},"Query"),t("th",{class:"px-6 py-3 text-left text-xs font-semibold text-green-900 uppercase tracking-wider"},"Count"),t("th",{class:"px-6 py-3 text-left text-xs font-semibold text-green-900 uppercase tracking-wider"},"Percentage")])],-1)),t("tbody",vt,[(a(!0),l(b,null,m(s.report.data.top_searches,(r,n)=>(a(),l("tr",{key:n,class:"hover:bg-green-50 transition"},[t("td",kt,[t("span",$t,d(n+1),1)]),t("td",St,[t("span",Lt,d(r.query),1)]),t("td",Ct,[t("span",jt,d(r.count.toLocaleString()),1)]),t("td",Dt,[t("div",Rt,[t("div",Tt,[t("div",{class:"bg-green-900 h-2 rounded-full transition-all",style:f({width:`${x(r.count,s.report.data.total_searches)}%`})},null,4)]),t("span",Ft,d(x(r.count,s.report.data.total_searches))+"% ",1)])])]))),128)),s.report.data.top_searches?.length?c("",!0):(a(),l("tr",Mt,[...e[7]||(e[7]=[t("td",{colspan:"4",class:"px-6 py-8 text-center text-gray-500"}," No search data available ",-1)])]))])])])]),s.report.data.guest_roles?.length?(a(),l("div",qt,[e[10]||(e[10]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"User Roles Distribution"),t("p",{class:"text-sm text-green-700 mt-1"},"Breakdown of searches by user role")],-1)),t("div",Ut,[t("div",Bt,[(a(!0),l(b,null,m(s.report.data.guest_roles,(r,n)=>(a(),l("div",{key:n,class:"bg-green-50 rounded-lg p-4 border border-green-200"},[t("div",Pt,[t("span",Vt,d(r.role),1),t("span",zt,d(r.count),1)]),t("div",At,[t("div",{class:"bg-green-900 h-2 rounded-full",style:f({width:`${x(r.count,s.report.data.total_searches)}%`})},null,4)])]))),128))])])])):c("",!0)])):c("",!0),s.report.type==="feedback"?(a(),l("div",Nt,[t("div",Qt,[t("div",Et,[e[11]||(e[11]=t("p",{class:"text-sm font-medium text-green-700 mb-2"},"Total Feedback",-1)),t("p",Ot,d(s.report.data.total_feedback?.toLocaleString()||0),1)])]),t("div",Ht,[t("div",Zt,[e[12]||(e[12]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"By Location")],-1)),t("div",Gt,[(a(!0),l(b,null,m(s.report.data.feedback_by_location,(r,n)=>(a(),l("div",{key:n,class:"flex items-center justify-between"},[t("span",Wt,d(r.location),1),t("div",Xt,[t("div",It,[t("div",{class:"bg-green-900 h-2 rounded-full",style:f({width:`${x(r.count,s.report.data.total_feedback)}%`})},null,4)]),t("span",Yt,d(r.count),1)])]))),128))])]),s.report.data.feedback_by_role?.length?(a(),l("div",Jt,[e[13]||(e[13]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"By Role")],-1)),t("div",Kt,[(a(!0),l(b,null,m(s.report.data.feedback_by_role,(r,n)=>(a(),l("div",{key:n,class:"flex items-center justify-between"},[t("span",te,d(r.role),1),t("div",ee,[t("div",oe,[t("div",{class:"bg-green-900 h-2 rounded-full",style:f({width:`${x(r.count,s.report.data.total_feedback)}%`})},null,4)]),t("span",re,d(r.count),1)])]))),128))])])):c("",!0)])])):c("",!0),s.report.type==="facility"?(a(),l("div",se,[t("div",de,[t("div",ne,[e[14]||(e[14]=t("p",{class:"text-sm font-medium text-green-700 mb-2"},"Total Facilities",-1)),t("p",ae,d(s.report.data.total_facilities?.toLocaleString()||0),1)])]),t("div",le,[t("div",ie,[e[15]||(e[15]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"By Category")],-1)),t("div",ce,[(a(!0),l(b,null,m(s.report.data.facilities_by_category,(r,n)=>(a(),l("div",{key:n,class:"flex items-center justify-between"},[t("span",he,d(r.category),1),t("div",ge,[t("div",ue,[t("div",{class:"bg-green-900 h-2 rounded-full",style:f({width:`${x(r.count,s.report.data.total_facilities)}%`})},null,4)]),t("span",be,d(r.count),1)])]))),128))])]),s.report.data.facilities_by_department?.length?(a(),l("div",me,[e[16]||(e[16]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"By Department")],-1)),t("div",pe,[(a(!0),l(b,null,m(s.report.data.facilities_by_department,(r,n)=>(a(),l("div",{key:n,class:"flex items-center justify-between"},[t("span",xe,d(r.department),1),t("div",fe,[t("div",ye,[t("div",{class:"bg-green-900 h-2 rounded-full",style:f({width:`${x(r.count,s.report.data.total_facilities)}%`})},null,4)]),t("span",we,d(r.count),1)])]))),128))])])):c("",!0)])])):c("",!0),s.report.type==="search"?(a(),l("div",_e,[t("div",ve,[t("div",ke,[e[17]||(e[17]=t("p",{class:"text-sm font-medium text-green-700 mb-2"},"Total Searches",-1)),t("p",$e,d(s.report.data.total_searches?.toLocaleString()||0),1)]),t("div",Se,[e[18]||(e[18]=t("p",{class:"text-sm font-medium text-green-700 mb-2"},"Unique Queries",-1)),t("p",Le,d(s.report.data.unique_queries?.toLocaleString()||0),1)])]),t("div",Ce,[t("div",je,[e[19]||(e[19]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"Top 10 Searches")],-1)),t("div",De,[(a(!0),l(b,null,m(s.report.data.top_10_searches,(r,n)=>(a(),l("div",{key:n,class:"flex items-center gap-3"},[t("span",Re,d(n+1),1),t("span",Te,d(r.query),1),t("span",Fe,d(r.search_count),1)]))),128))])]),s.report.data.bottom_10_searches?.length?(a(),l("div",Me,[e[20]||(e[20]=t("div",{class:"px-6 py-4 border-b border-green-200 bg-green-50"},[t("h3",{class:"text-lg font-semibold text-green-900"},"Bottom 10 Searches")],-1)),t("div",qe,[(a(!0),l(b,null,m(s.report.data.bottom_10_searches,(r,n)=>(a(),l("div",{key:n,class:"flex items-center gap-3"},[t("span",Ue,d(r.query),1),t("span",Be,d(r.search_count),1)]))),128))])])):c("",!0)])])):c("",!0)])]),_:1}))}},Ze=A(Pe,[["__scopeId","data-v-62ed955e"]]);export{Ze as default};
